    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental > 1595 && frecuenciaFundamental < 1605)
                {
                    lbl_Color.Text = "Azul";

                }

                if (frecuenciaFundamental > 795 && frecuenciaFundamental < 805)
                {
                    lbl_Color.Text = "Verde";

                }

                if (frecuenciaFundamental > 395 && frecuenciaFundamental < 405)
                {
                    lbl_Color.Text = "Rojo";
                }

                if (frecuenciaFundamental > 1995 && frecuenciaFundamental < 2005)
                {
                    lbl_Color.Text = "Amarillo";

                }

                if (frecuenciaFundamental > 1195 && frecuenciaFundamental < 1205)
                {
                    lbl_Color.Text = "Morado";
